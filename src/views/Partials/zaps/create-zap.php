<div id="createzap" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative w-full h-full max-w-lg md:h-auto">
        ...
        <div class="relative rounded-lg shadow bg-[#111414]">
            ...
            <div class="px-6 py-6 lg:px-8">
                <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Создать запись</h3>
                
                <form class="space-y-3" action="/Profile/Bank">
                    <h3 class="mb-2 text-base font-medium text-gray-900 dark:text-white">Ваши мысли</h3>
