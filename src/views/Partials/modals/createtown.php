                ...
                <form class="space-y-6" action="#">
                    ...
                    <div>
                        ...
                        <input type="text" name="banner" id="banner"
                            ...
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-tavern-grid-br dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                            required>
                        <p class="text-white mt-2 text-sm">Создайте баннер на <a href="#" class="text-tavern-link underline hover:no-underline">Planet Minecraft</a> и вставьте сюда Shareable URL</p>
                    </div>
                    <div>
                        <label for="discord"
                    ...
                    <div>
                        <label for="href" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Ссылка на
                            город</label>
                        <input type="text" name="href" id="href" placeholder="ссылка на сайт/города/"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-tavern-grid-br dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                            required>
                    </div>
                    <button type="submit"
