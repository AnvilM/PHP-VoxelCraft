<!-- Main modal -->
<div id="fine" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-tavern-black">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form class="space-y-6" action="/Profile">
                    ...
                    <button type="submit"
                        class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-[#EA3D2D] dark:hover:bg-[#b13328] dark:focus:ring-[#b13328]">Выписать
                        штраф</button>
