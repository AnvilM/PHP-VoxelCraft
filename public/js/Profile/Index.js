	...
	camera = new THREE.PerspectiveCamera(75, document.getElementById('model').offsetWidth/document.getElementById('model').offsetHeight, 0.1, 1000);
	...
	img.src = 'https://minotar.net/skin/AnvilW';
